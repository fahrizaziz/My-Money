...
class UserPreferences {
  ...
  Future<bool> setIdUser(String idUser) async {
    final pref = await SharedPreferences.getInstance();
    return pref.setString(UserPref.idUser.toString(), idUser);
  }

  Future<String?> getIdUser() async {
    final pref = await SharedPreferences.getInstance();
    return pref.getString(UserPref.idUser.toString());
  }

  Future<bool> clearIdUser() async {
    return clear(UserPref.idUser.toString());
  }
}
